...
export const toolInputSchemas = {
    ...
    canvas_create_storyboard_shots: z.object({ shots: z.array(z.object({ shotId: z.string().min(1), title: z.string().min(1), description: z.string().optional(), position: z.number().int().min(0).optional() })).min(1).max(100), x: z.number().optional(), direction: z.enum(["column", "row"]).optional() }),
