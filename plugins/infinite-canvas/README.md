...
```text
请从 https://github.com/ddcat666/open-ai-canvas.git 安装 Infinite Canvas Codex 插件。
...
```bash
mkdir -p ~/plugins
git clone https://github.com/ddcat666/open-ai-canvas.git ~/plugins/open-ai-canvas
```
