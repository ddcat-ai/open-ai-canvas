...
func migrations() []tableMigration {
	return []tableMigration{
		...
		migrateTable[model.PaymentChannelVersion]("payment_channel_versions"),
		migrateTable[model.CreditRechargeProduct]("credit_recharge_products"),
		migrateTable[model.PaymentOrder]("payment_orders"),
		migrateTable[model.PaymentEvent]("payment_events"),
		migrateTable[model.PaymentReconciliationRun]("payment_reconciliation_runs"),
		migrateTable[model.PaymentReconciliationDifference]("payment_reconciliation_differences"),
