...
func migrations() []tableMigration {
	return []tableMigration{
		...
		migrateTable[model.CreditPackage]("credit_packages"),
		migrateTable[model.PaymentChannel]("payment_channels"),
		migrateTable[model.PaymentChannelConfigVersion]("payment_channel_config_versions"),
		migrateTable[model.CreditRechargeOrder]("credit_recharge_orders"),
		migrateTable[model.PaymentNotificationEvent]("payment_notification_events"),
		migrateTable[model.PaymentReconciliationRun]("payment_reconciliation_runs"),
		migrateTable[model.PaymentReconciliationAnomaly]("payment_reconciliation_anomalies"),
