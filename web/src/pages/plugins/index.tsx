...
export default function PluginsPage() {
    ...
    // 工作流插件的配置属于当前用户；协议和站点级插件仍只允许管理员配置。
    const canConfigurePlugin = (plugin: RegisteredPlugin) => hasPluginConfiguration(plugin) && (user?.role === "admin" || plugin.manifest.category === "workflow");
