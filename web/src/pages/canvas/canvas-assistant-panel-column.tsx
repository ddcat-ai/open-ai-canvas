    ...
    return (
        ...
        >
            <div className="h-full w-full">
                {!closing ? <button type="button" className="absolute inset-y-0 left-0 z-[var(--node-z-overlay)] w-4 -translate-x-1/2 cursor-col-resize" onMouseDown={startResize} aria-label={t("canvas:resize-right-panel")} /> : null}
                {children(resizing)}
            </div>
        </div>
    );
