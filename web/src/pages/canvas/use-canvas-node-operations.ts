...
import { CanvasNodeType, type CanvasConnection, type CanvasFolderStyle, type CanvasFolderTheme, type CanvasNodeData, type CanvasNodeMetadata, type ContextMenuState, type Position } from "@/types/canvas";
...
export function useCanvasNodeOperations({
    ...
    const createNode = useCallback((type: CanvasNodeType, position?: Position, workflowProvider?: "runninghub" | "comfyui") => {
