...
export function CanvasProjectMediaDialogs({
    ...
    return (
        <>
            ...
            {maskEditNode?.metadata?.content ? <CanvasNodeMaskEditDialog config={{} as any} dataUrl={maskEditNode.metadata.content} open onClose={onCloseMaskEdit} onConfirm={(payload) => onMaskEdit(maskEditNode, payload)} /> : null}
