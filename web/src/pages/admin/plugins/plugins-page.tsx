...
const officialApplicationIds = new Set([RUNNINGHUB_PLUGIN_ID, COMFYUI_PLUGIN_ID, EAGLE_PLUGIN_ID, PROMPT_OPTIMIZER_PLUGIN_ID, "portrait-clearance", WORKBENCH_PLUGIN_ID, MEDIA_CONVERSION_PLUGIN_ID]);
