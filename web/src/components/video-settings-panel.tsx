...
import { normalizeVideoDuration, normalizeVideoResolution, VIDEO_DURATION_MIN, videoResolutionForSize, videoSizeForResolution } from "@/lib/video-generation-options";
