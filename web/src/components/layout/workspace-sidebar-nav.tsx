        ...
        <div className="flex h-full w-[var(--workspace-sidebar-nav-width)] shrink-0 flex-col">
            ...
            <div className="shrink-0 px-3 pb-1 pt-2">
                <button
                    ...
                    className="group flex h-9 w-full items-center gap-2 rounded-[var(--r-sm)] bg-foreground/5 px-3 text-left text-[var(--fs-caption)] text-foreground/42 transition-colors hover:bg-foreground/[.07] hover:text-foreground/70"
                >
