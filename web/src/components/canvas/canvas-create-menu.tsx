...
export function CanvasCreateMenu({ commands }: { commands: CanvasCreateCommand[] }) {
    ...
    return (
        <div>
            ...
            <MenuSection title={t("domain:creation-nodes")} color={theme.node.muted} />
            <CanvasCreateCommandGrid commands={nodeCommands} variant="node" />

            {extensionCommands.length ? (
                <>
                    <MenuSection title={t("domain:display-and-processing")} color={theme.node.muted} spaced />
                    <CanvasCreateCommandGrid commands={extensionCommands} variant="node" />
                </>
            ) : null}

            <MenuSection title={t("domain:import-resources")} color={theme.node.muted} spaced />
