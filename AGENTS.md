...
| `plugins/infinite-canvas/` | Codex App 插件清单和 skills | `.codex-plugin/plugin.json` | 将 Canvas Agent MCP 接入 Codex App |
...
- 修改 `plugins/infinite-canvas/` 前先读插件 README、manifest 和对应 skill；不要把主应用的页面约定套到插件运行时。
